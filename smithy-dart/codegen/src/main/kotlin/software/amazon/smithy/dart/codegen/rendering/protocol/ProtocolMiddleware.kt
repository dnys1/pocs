...
interface ProtocolMiddleware {
     ...
     */
    fun render(ctx: ProtocolGenerator.GenerationContext, op: OperationShape, writer: DartWriter)
     ...
     */
    fun renderProperties(writer: DartWriter) {}
}
...
abstract class HttpFeatureMiddleware : ProtocolMiddleware {
    ...
    override fun render(ctx: ProtocolGenerator.GenerationContext, op: OperationShape, writer: DartWriter) {
     ...
     * ```
     */
    open fun renderConfigure(writer: DartWriter) {}
}
