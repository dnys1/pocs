...
import software.amazon.smithy.dart.codegen.model.SymbolProperty
...
class ShapeValueGenerator(
     ...
     */
    fun writeShapeValueInline(writer: DartWriter, shape: Shape, params: Node) {
    ...
    private fun classDeclaration(writer: DartWriter, shape: StructureShape, block: () -> Unit) {
    ...
    private fun mapDeclaration(writer: DartWriter, shape: MapShape, block: () -> Unit) {
        writer.pushState()
    ...
    private fun collectionDeclaration(writer: DartWriter, shape: CollectionShape, block: () -> Unit) {
        writer.pushState()
        writer.trimTrailingSpaces(false)
    ...
    private fun primitiveDeclaration(writer: DartWriter, shape: Shape, block: () -> Unit) {
