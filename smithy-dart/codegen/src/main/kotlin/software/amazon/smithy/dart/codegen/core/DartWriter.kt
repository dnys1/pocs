...
import software.amazon.smithy.dart.codegen.integration.SectionWriter
 ...
 */
fun DartWriter.registerSectionWriter(id: SectionId, writer: SectionWriter): DartWriter {
...
class DartWriter(private val fullPackageName: String) : CodeWriter() {
     ...
     * ```
     */
    private fun dokka(block: DartWriter.() -> Unit) {
        pushState()
        setNewlinePrefix("/// ")
        block(this)
        popState()
