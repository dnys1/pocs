...
import software.amazon.smithy.dart.codegen.model.isError
...
class StructureGenerator(
    ...
    private fun renderCompanionObject() {
        writer.withBlock("companion object {", "}") {
            ...
            write("")
            write("operator fun invoke(block: DslBuilder.() -> #Q): #class.name:L = BuilderImpl().apply(block).build()", DartTypes.void)
            write("")
        }
    }
    ...
    private fun renderToString() {
        writer.write("")
        writer.withBlock("override fun toString(): #Q = buildString {", "}", DartTypes.String) {
    ...
    private fun renderHashCode() {
        writer.write("")
        writer.withBlock("override fun hashCode(): #Q {", "}", DartTypes.int) {
            when {
    ...
    private fun renderEquals() {
        writer.write("")
        writer.withBlock("override fun equals(other: #Q?): #Q {", "}", DartTypes.Object, DartTypes.bool) {
    ...
    private fun renderCopy() {
        ...
        writer.write("")
            .write("fun copy(block: DslBuilder.() -> #Q = {}): #class.name:L = BuilderImpl(this).apply(block).build()", DartTypes.void)
            .write("")
    }
        ...
        writer.write("")
            .withBlock("interface DslBuilder {", "}") {
                ...
                for (member in structMembers) {
                    ...
                    writer.renderAnnotations(member)
                    openBlock("fun #L(block: #L.DslBuilder.() -> #Q) {", memberName, memberSymbol.name, DartTypes.void)
