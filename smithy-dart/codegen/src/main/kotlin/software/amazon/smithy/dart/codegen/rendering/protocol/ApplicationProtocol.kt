...
class ApplicationProtocol(
    ...
    companion object {
        ...
        fun createDefaultHttpApplicationProtocol(): ApplicationProtocol = ApplicationProtocol(
            "http",
            createHttpSymbol("HttpRequestBuilder"),
            createHttpSymbol("HttpResponse")
        )

        private fun createHttpSymbol(symbolName: String): Symbol = Symbol
            .builder()
            .name(symbolName)
            .namespace("package.http", ".")
            .addDependency(DartDependency.http)
            .build()
    }
}
