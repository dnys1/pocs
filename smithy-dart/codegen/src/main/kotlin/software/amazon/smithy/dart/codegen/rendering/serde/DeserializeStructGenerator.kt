...
import software.amazon.smithy.dart.codegen.model.isSparse
import software.amazon.smithy.dart.codegen.model.targetOrSelf
...
open class DeserializeStructGenerator(
    ...
    protected val writer: DartWriter,
    ...
    protected fun deserializerForShape(shape: Shape): String {
        ...
        return when (target.type) {
            ...
            ShapeType.BLOB -> {
                writer.addImport("decodeBase64Bytes", DartDependency.UTILS)
